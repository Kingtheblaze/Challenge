...
import { User, Menu, X, Sparkles, TrendingUp } from "lucide-react"
      ...
      <nav className="md:hidden border-b border-border/50 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 sticky top-0 z-50 w-full">
        <div className="container mx-auto px-6 py-5">
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <span className="font-bold tracking-tight text-xl">Go Viral</span>
            </Link>
            <button
        ...
        {mobileMenuOpen && (
          <div className="border-t border-border/50 px-6 py-4 space-y-4">
            <Link
              href="/analyzer"
              className={`block py-2 ${pathname === "/analyzer" ? "text-primary font-bold" : ""}`}
        ...
        <div className="container mx-auto px-6 py-5">
          <div className="flex items-center justify-between">
            ...
            >
              ...
              <span className="font-bold tracking-tight text-2xl">Go Viral</span>
            </Link>
            ...
            <div className="flex items-center gap-8">
              <Link
                ...
                className={`text-sm font-medium transition-colors ${
                  pathname === "/analyzer" ? "text-primary" : "text-foreground/80 hover:text-foreground"
                }`}
              >
                Analyzer
              </Link>
                ...
                <>
                  {user ? (
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <Button size="sm" className="text-sm rounded-lg" asChild>
